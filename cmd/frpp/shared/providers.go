...
import (
	...
	bizcommon "github.com/fishcpy/frp-panel/biz/common"
	...
	"github.com/fishcpy/frp-panel/services/api"
	"github.com/fishcpy/frp-panel/services/app"
	"github.com/fishcpy/frp-panel/services/dao"
	"github.com/fishcpy/frp-panel/services/master"
	"github.com/fishcpy/frp-panel/services/mux"
	"github.com/fishcpy/frp-panel/services/rbac"
	...
	"github.com/fishcpy/frp-panel/utils/wsgrpc"
...
func NewDefaultServerConfig(ctx *app.Context) conf.Config {
	...
	// 同时更新全局配置，确保 appInstance.GetMasterCli() 等使用正确的配置
	appInstance.SetConfig(tmpCfg)
